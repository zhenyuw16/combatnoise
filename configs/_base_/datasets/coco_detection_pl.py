...
train_pipeline = [
    ...
    dict(type='Collect', keys=['img', 'gt_bboxes', 'gt_labels', 'gt_bboxes_scores']),
]
test_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(
        ...
        datasets=[
            dict(type='RepeatDataset',
                ...
                dataset = dict(type=dataset_type,
                    ann_file=data_root + 'annotations/instances_valminusminival2014_score.json',
                    img_prefix=data_root + 'images/val2014/',
                    pipeline=train_pipeline,
                    with_score=True)),
                dict(type=dataset_type,
                    ann_file='labels/cocotrain2014_pl.json',
